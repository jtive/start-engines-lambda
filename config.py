...
SERVICE_MAPPINGS: Dict[str, ServiceConfig] = {
    'auth': {
        'cluster': os.environ.get('AUTH_CLUSTER', 'auth-cluster'),
        'task_definition': os.environ.get('AUTH_TASK_DEF', 'auth-api-task'),
        'target_group_arn': f"arn:aws:elasticloadbalancing:{AWS_REGION}:{AWS_ACCOUNT_ID}:targetgroup/auth-lb/0f8e49d7cd37c0c9",
    ...
    'pdf': {
        'cluster': os.environ.get('PDF_CLUSTER', 'pdf-cluster'),
        'task_definition': os.environ.get('PDF_TASK_DEF', 'pdf-creator-task'),
        'target_group_arn': f"arn:aws:elasticloadbalancing:{AWS_REGION}:{AWS_ACCOUNT_ID}:targetgroup/pdf-lb/d571f1c694ab39bd",
    ...
    'fa': {
        'cluster': os.environ.get('FA_CLUSTER', 'fa-cluster'),
        'task_definition': os.environ.get('FA_TASK_DEF', 'fa-engine-task'),
        'target_group_arn': f"arn:aws:elasticloadbalancing:{AWS_REGION}:{AWS_ACCOUNT_ID}:targetgroup/fa2-tg/91a958683a8eaa6d",
    ...
    'users': {
        'cluster': os.environ.get('USERS_CLUSTER', 'users-cluster'),
        'task_definition': os.environ.get('USERS_TASK_DEF', 'user-management-task'),
        'target_group_arn': os.environ.get('USERS_TARGET_GROUP_ARN', ''),  # To be created
    ...
    'batch': {
        'cluster': os.environ.get('BATCH_CLUSTER', 'batch-cluster'),
        'task_definition': os.environ.get('BATCH_TASK_DEF', 'batch-engine-task'),
        'target_group_arn': os.environ.get('BATCH_TARGET_GROUP_ARN', ''),  # To be created
